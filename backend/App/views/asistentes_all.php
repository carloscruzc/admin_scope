        ...
        <div class="container-fluid">
            <div class=" mt-7 mb-4">
                <div class="card card-body mt-n6 overflow-hidden">
                    <div class="row gx-4">
                        <div class="col-auto">
                            <div class="bg-gradient-cardio avatar avatar-xl position-relative">
                                    ...
                                    <form class="form-inline my-2 my-lg-0" action="/Asistentes/Usuario" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-12 mt-md-2">
                                                <button class="btn max-btn-lg btn-blue-cardio text-gray my-2 my-sm-0" type="submit">Buscar</button>
                                            </div>
                                        </div>
